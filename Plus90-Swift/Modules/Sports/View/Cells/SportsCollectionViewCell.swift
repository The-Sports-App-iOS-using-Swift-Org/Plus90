...
class SportsCollectionViewCell: UICollectionViewCell {
    ...
    private func setupCellUI() {
        ...
        self.layer.shadowColor = UIColor.black.cgColor  // always black
    ...
    private func applyTheme() {
        self.contentView.backgroundColor = AppColors.cardBackground
        sportsTitle.textColor = AppColors.primaryText
    }
